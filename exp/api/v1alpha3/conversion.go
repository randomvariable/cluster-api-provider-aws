...
func (r *AWSMachinePool) ConvertTo(dstRaw conversion.Hub) error {
	...
	if restored.Spec.AWSLaunchTemplate.RootVolume != nil && restored.Spec.AWSLaunchTemplate.RootVolume.Encrypted == nil {
		dst.Spec.AWSLaunchTemplate.RootVolume.Encrypted = nil
	}
